...
export default function ThankYouPage() {
  ...
  const projects = [
    {
      id: "la-casalia",
      name: "La Casalia",
      description: t.projectDescriptions.laCasalia,
      image:
    ...
    },
    {
      id: "natalux",
      name: "Natalux",
      description: t.projectDescriptions.natalux,
      image:
    ...
    },
    {
      id: "la-isla",
      name: "La Isla",
      description: t.projectDescriptions.laIsla,
      image:
    ...
    },
    {
      id: "panorama",
      name: "Panorama",
      description: t.projectDescriptions.panorama,
      image:
  ...
  // Location translations based on language
  ...
  // Update project locations based on language
  const localizedProjects = projects.map((project) => {
    let location = project.location

    if (project.id === "la-casalia") {
      location = locationTranslations[language]?.kyrenia || locationTranslations.en.kyrenia
    } else if (project.id === "natalux") {
      location = locationTranslations[language]?.famagusta || locationTranslations.en.famagusta
    } else if (project.id === "la-isla") {
      location = locationTranslations[language]?.bafra || locationTranslations.en.bafra
    } else if (project.id === "panorama") {
      location = locationTranslations[language]?.iskele || locationTranslations.en.iskele
    }
    ...
    <main className="min-h-screen bg-[#f8f8f8] text-[#1a1a1a] relative overflow-hidden">
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: "Home",
                item: "https://querencia.com",
              },
              {
                "@type": "ListItem",
                position: 2,
                name: "Thank You",
                item: "https://querencia.com/thank-you",
              },
            ],
          }),
        }}
      ...
      <div className="container mx-auto px-4 py-12 md:py-20 relative z-10">
        ...
        <div className="mx-auto mt-12 max-w-3xl text-center md:mt-20 fade-in-delay-3">
          <h2 className="mb-6 text-2xl font-light tracking-wider text-[#1a1a1a] md:text-3xl">{t.discoverMore.title}</h2>
