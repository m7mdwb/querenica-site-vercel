...
export default function ThankYouContent({ dict, locale }: ThankYouContentProps) {
    ...
    <div className="min-h-screen bg-gradient-to-b from-luxury-50 to-platinum-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        ...
        <div className="flex items-center text-sm text-platinum-600 mb-8">
          ...
          <span className="text-secondary">{dict["thankYou.title"]}</span>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {/* Logo */}
            <div className="mb-8">
              <img src="/images/design-mode/dark_logo_querencia.png" alt="Querencia" className="h-20 mx-auto" />
            </div>
            ...
            {/* What Happens Next */}
            <div className="mb-12">
              <h2 className="text-2xl font-light text-primary mb-8">{dict["thankYou.whatHappensNext"]}</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
                <div className="bg-gradient-to-br from-secondary/5 to-accent/5 rounded-xl p-6 border border-secondary/10">
                  ...
                  <p className="text-platinum-700 text-sm leading-relaxed">{dict["thankYou.step1"]}</p>
                </div>
                <div className="bg-gradient-to-br from-secondary/5 to-accent/5 rounded-xl p-6 border border-secondary/10">
                  <div className="w-8 h-8 bg-gradient-to-br from-secondary to-accent rounded-full flex items-center justify-center text-white text-sm font-medium mb-4">
                    2
                  </div>
                  <p className="text-platinum-700 text-sm leading-relaxed">{dict["thankYou.step2"]}</p>
                </div>
                <div className="bg-gradient-to-br from-secondary/5 to-accent/5 rounded-xl p-6 border border-secondary/10">
                  <div className="w-8 h-8 bg-gradient-to-br from-secondary to-accent rounded-full flex items-center justify-center text-white text-sm font-medium mb-4">
                    3
                  </div>
                  <p className="text-platinum-700 text-sm leading-relaxed">{dict["thankYou.step3"]}</p>
                </div>
              </div>
            </div>
            ...
            <div className="mb-12">
              <h3 className="text-xl font-light text-primary mb-6">{dict["thankYou.immediateAssistance"]}</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl border border-secondary/20 p-6 flex items-center">
                  ...
                  <div className="text-left">
                    <p className="text-sm text-platinum-600 mb-1">{dict["thankYou.callDirectly"]}</p>
                    <a
                ...
                <div className="bg-gradient-to-r from-secondary/5 to-accent/5 rounded-xl border border-secondary/20 p-6 flex items-center">
                  ...
                  <div className="text-left">
                    <p className="text-sm text-platinum-600 mb-1">{dict["thankYou.emailTeam"]}</p>
                    <a
            ...
            <div className="mb-8">
              <a
                ...
                className="inline-flex group bg-gradient-to-r from-secondary to-accent text-white py-4 px-8 rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-secondary/30 hover:scale-105 items-center justify-center font-medium relative overflow-hidden"
              >
                ...
                <span className="relative z-10">{dict["thankYou.downloadCatalog"]}</span>
              </a>
            </div>
          </div>
        </div>

        {/* View Our Other Projects Section */}
        <ProjectCarousel dict={dict} />
      </div>
    </div>
  )
}
