    ...
    <section ref={ref} id="residences" className="bg-[#f8f8f8] py-20 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 flex flex-col items-center justify-center">
          ...
          <div className="mb-6 flex w-full max-w-md flex-col space-y-4">
        ...
        <div className="mt-20 flex flex-col items-center justify-center space-y-6 md:mt-32">
          ...
          <Button size="lg" className="bg-[#0a1a2a] text-white hover:bg-[#132639]" asChild>
            <Link href="https://sites.google.com/view/querencia360/" target="_blank" className="flex items-center">
              ...
              <div className="relative aspect-video w-full">
                ...
                {selectedResidence.images.length > 1 && (
                  <>
                    ...
                    <button
                      onClick={prevImage}
                      className="absolute left-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-[#0a1a2a] shadow-md transition-all hover:bg-white active:scale-95"
                      aria-label="Previous image"
                    >
                    ...
                    <button
                      onClick={nextImage}
                      className="absolute right-4 top-1/2 flex h-10 w-10 -translate-y-1/2 items-center justify-center rounded-full bg-white/80 text-[#0a1a2a] shadow-md transition-all hover:bg-white active:scale-95"
                      aria-label="Next image"
                    >
              ...
              <div className="p-6 sm:p-8">
                ...
                <div className="mt-8 flex flex-col items-center justify-between gap-4 sm:flex-row">
                  <Button variant="outline" asChild>
                    <Link
                      href="https://sites.google.com/view/querencia360/"
                      target="_blank"
